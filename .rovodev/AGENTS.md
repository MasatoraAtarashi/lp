...
rules[2]:
  - path: @.rovodev/.rulesync/modular-rules/communication.md
    description: 応答言語・簡潔さ・検証の義務などのコミュニケーション規約
    applyTo[1]: **/*
  - path: @.rovodev/.rulesync/modular-rules/security.md
    description: secrets 管理とフック回避禁止などのセキュリティルール
    applyTo[1]: **/*
