...
| `public/images/02-shop.jpg`         | イントロ / 雰囲気       | 日常の店先                                          |
| `public/images/06-evening.jpg`      | 流れ 03 / 雰囲気 / 末尾 | 夕方〜夜                                            |
| `public/images/07-alley.jpg`        | 届くもの / 流れ 01      | 夜の路地                                            |
| `public/images/08-lantern-shop.jpg` | 流れ 02 / 雰囲気（大）  | 灯りのある店先                                      |

写真は 5 枚しかないので、いくつかのスロットで使い回しています。差し替えるときは 1 スロット 1 枚に戻して構いません。

元テンプレートに入っていた `03-street-walk.jpg`（大阪・新世界）、`04-quiet-town.jpg` と `05-stone-path.jpg`（長野・妻籠宿）は、別都市のストック写真なので削除しました。経緯は `public/images/CREDITS.txt` に残しています。
